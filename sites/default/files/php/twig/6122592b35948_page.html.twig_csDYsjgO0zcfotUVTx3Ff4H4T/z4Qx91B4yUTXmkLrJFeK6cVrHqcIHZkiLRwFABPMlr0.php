...
class __TwigTemplate_dff4fd58ef41f9db81ab4463a79571c8d0887995cecdf1eca63e553cc555c280 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "banner", [], "any", false, false, true, 219)) {
            ...
            // line 221
            echo "    <div ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(((($context["banner_id"] ?? null)) ? ((("id=\"" . $this->sandbox->ensureToStringAllowed(($context["banner_id"] ?? null), 221, $this->source)) . "\"")) : ("")));
